...
namespace UoFiddler.Plugin.FontSeaHatsPlugin
{
    public class FontPluginSeahats : PluginBase
    {
        private const string _itemDescFileName = "itemdesc.cfg";

        public FontPluginSeahats()
        {
        ...
        /// Name of the plugin
        /// </summary>
        public override string Name { get; } = "PluginSeaHats";

        /// <summary>
        /// Description of the Plugin's purpose
        /// </summary>
        public override string Description { get; } = "You can modify the font, add more font and other stuffs";
